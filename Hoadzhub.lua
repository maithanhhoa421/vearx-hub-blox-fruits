...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://88427699107483",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=88427699107483";
v24.Parent = v23;
...
v16.Shop:AddButton({
    Title = "Đổi Tộc",
    Description = "dùng để đổi tộc tốn 3k fragment",
    Callback = function()
...
v16.Shop:AddButton({
    Title = "Đổi Tộc Ghoul",
    Description = "dùng để đổi tộc tốn 0 fragment",
    Callback = function()
        local v366 = {
            [1] = "Ectoplasm",
            [2] = "Change",
...
v16.Shop:AddButton({
    ...
    Description = "dùng để đổi tộc cần 2k5 fragment",
    Callback = function()
        local v367 = {
            [1] = "CyborgTrainer",
            [2] = "Buy"
